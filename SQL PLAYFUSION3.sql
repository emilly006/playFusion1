...
FK_PremioJogoEquipeCompetição_DATA 
FK_PREMIO_CODIGO,
...
FK_COMPETIÇÃOEQUIPEjOGO_TAXADEINSCRICAO INT,
FK_JOGO_CODIGO VARCHAR(10),
FK_EQUIPE_IDDAEQUIPE VARCHAR(15),
FK_COMPETICAO_CODIGO VARCHAR(20),
FOREIGN KEY(FK_JOGO_CODIGO) REFERENCES JOGO (CODIGO),
...
INSERT INTO competicaoEquipeJogo( FK_PREMIO_CODIGO, FK_JOGO_CODIGO, FK_EQUIPE_IDDAEQUIPE, FK_COMPETICAO_CODIGO)
VALUES('444B', '2222', '5555', '505');
INSERT INTO competicaoEquipeJogo(FK_PREMIO_CODIGO, FK_JOGO_CODIGO, FK_EQUIPE_IDDAEQUIPE, FK_COMPETICAO_CODIGO)
VALUES('494B', '2262', '5556', '565');
INSERT INTO competicaoEquipeJogo(FK_PREMIO_CODIGO, FK_JOGO_CODIGO, FK_EQUIPE_IDDAEQUIPE, FK_COMPETICAO_CODIGO)
VALUES('444AB', '2252', '5522', '557');

#competicaoEquipeJogo

INSERT INTO competicaoEquipeJogo(FK_COMPETICAOEQUIPEjOGO_TAXADEINSCRICAO, FK_JOGO_CODIGO,
FK_EQUIPE_IDDAEQUIPE, FK_COMPETICAO_CODIGO)
VALUES(50, '2222', '5555', '505');
INSERT INTO competicaoEquipeJogo(FK_COMPETICAOEQUIPEjOGO_TAXADEINSCRICAO, FK_JOGO_CODIGO,
FK_EQUIPE_IDDAEQUIPE, FK_COMPETICAO_CODIGO)
VALUES(45, '2262', '5556', '565');
INSERT INTO competicaoEquipeJogo(FK_COMPETICAOEQUIPEjOGO_TAXADEINSCRICAO, FK_JOGO_CODIGO,
FK_EQUIPE_IDDAEQUIPE, FK_COMPETICAO_CODIGO)
VALUES(35, '2252', '5522', '557');
